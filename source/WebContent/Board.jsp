...
%>
    ...
    <a class="link-1" >
            ...
            <a class="link-1" href="outer.jsp">주문조회 </a>
          </nav>
    <!-- 제목 -->
		...
		<ul class="nav-menu clearfix unstyled">
			...
			<li><a href="main.jsp" class="three-d"> 패션 <span
				...
				<ul class="clearfix unstyled drop-menu">
					...
					<li><a href="exfashion.jsp" class="three-d"> 체형별 코디 <span
    ...
    <script>
        ...
        function select() {
            	var id='<%=id%>';
            	var table='<%=table%>'
            	var url2="addCart.jsp?id="+id+"&table="+table+"&inp_1="+inp_1.value+"&val1=null&val2=null";
                location.href=url2;
        }
    ...
    <div style="margin: 0 auto; width:1300px;padding-top: 65px;">
        ...
        <div style="float: left;"><img src="<%out.print(fashion.getMain_img());%>" width="674px;"></div>
        <div>
            <div>

                <ul style="padding-left: 57%;">
                    <hr style="margin:0 0 25px 0; background: #333;border: none; height: 2px;">
                    <li style="font-size:20px;color: #333"><%out.print(fashion.getName());%></li>
                    <li style="font-size:13px;color: #333;padding-top: 10px;" id="price">KRW <%out.print(fashion.getPrice());%></li>
                    <hr style="margin:20px 0 25px 0; background: #d4d3d3;border: none; height: 1px;">

                    <li style="margin-bottom: 26px;" class="input_value">
                        <input id="inp" value="1" type="text">
                        <a id="add">+</a>
                        <a id="sub">-</a>
                    </li>
                    <hr style="margin:25px 0 25px 0; background: #333;border: none; height: 2px; ">
                </ul>
            </div>
            <!-- 구매버튼 -->
            <div style="padding-left: 57%;margin-bottom: 600px;">
                <div class="btnArea ">
                    <a href="#" class="btnSubmit" style="margin-top: 15px; " onclick="select()">BUY</a>
                    <a href="#" class="btnNormal" style="margin:0 5px;" onclick="select()">ADD CART</a></KRW>
                    <a href="cart.jsp" class="btnNormal ">ADD WISH</a></span>
                </div>
                <div id="NaverChk_Button "></div>
            </div>
            <div align="center ">
                <div><img width="1300px" src="<%out.print(fashion.getSub_img());%>"></div>
        </div>
    </div>
    <div class="order">
        <div>

            <p style="font:14px '맑은 고딕';padding-left: 7px;color:#353535"><strong>REVIEW</strong></p>
        </div>

        <table border="0" class="review_table" style="margin:0 auto; margin-bottom: 40px;margin-bottom: 150px;">
            ...
            <thead>
                <tr>
                    <td colspan="5">
                        <hr style="margin:0;background: #d4d3d3;border: none;height: 2px;">
                    </td>
                </tr>
                <tr>
            ...
            <tfoot>
                <tr>
                    <td colspan="5">
                        <hr style="margin:0 auto;background: #d4d3d3;border: none;height: 2px; ">
                    </td>
                </tr>
            </tfoot>
        </table>
        ...
        <div class="item">댓글 작성</div>
			...
			<form align="center" name=insert method=post action=registerComment2.jsp?id=<%=id%>&table=<%=table%>>
