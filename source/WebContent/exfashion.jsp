...
<body style="margin:0;">
    ...
    <div id="instructions">
        ...
        <!-- } SE-TEXT -->
        <div align="center">
            <div class="box card-1" style="height: 330px; width: 330px"><img src="image/fashion_1.png" id="imgnew"></div>


            <div>
                <!-- SE-TEXT { -->
                <h2 style=" font-size: 20px; margin-top: 50px"><span>역 삼각형 체형</span></h2>
                <p><span>​</span></p>
            </div>
        ...
        <div align="center">
            <div class="box card-1" style="height: 330px; width: 330px"><img src="image/fashion_2.png" id="imgnew"></div>


            <div>
                <!-- SE-TEXT { -->
                <h2 style=" font-size: 20px; margin-top: 50px"><span>어깨가 좁은 체형</span></h2>
                <p><span>​</span></p>
            </div>
        ...
        <div align="center">
            <div class="box card-1" style="height: 330px; width: 330px"><img src="image/fashion_3.png" id="imgnew"></div>


            <div>
                <!-- SE-TEXT { -->
                <h2 style=" font-size: 20px; margin-top: 50px"><span>지방이 많은 체형</span></h2>
                <p><span>​</span></p>
            </div>
