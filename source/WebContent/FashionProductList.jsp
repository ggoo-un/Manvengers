...
%>
    ...
    String userid = (String) session.getAttribute("id");
		...
		<%}%>
		<a class="link-1" href="cart.html">장바구니 </a> <a class="link-1"
			href="order.html">주문조회 </a>
	</nav>
	<!-- 제목 -->
	<div align="center" style="padding: 50px 0 7px 0; height: 180px;">
		<a href="main.html"><img src="image/title.png" width="300px"
    ...
    <div align="center" style="margin-bottom: 160px;margin-top: 60px;">
        <table style="width:1300px;text-align: center" border="0">
            ...
            <tr>
                <td id="newtd">
                    <a id="a2" href="FashionBoard.jsp?id=<%out.print(list.get(i).getId());%>&table=<%=table%>"><img src="<%out.print(list.get(i).getMain_img());%>" id="imgnew"></a>
                    <div id="div1"><a href="FashionBoard.jsp?id=<%out.print(list.get(i).getId());%>&table=<%=table%>"><%out.print(list.get(i).getName());%></a>
                        <div style="margin-top: 4px;"><%out.print(list.get(i).getPrice());%></div>
                    </div>
                    <div align="center">
                        <div class="circle" style="background-color: #9d968c;"></div>
                        <div class="circle" style="background-color: #3d6939;"></div>
                        <div class="circle" style="background-color: #154579;"></div>
                    </div>
                </td>
                <td id="newtd">
                    <a id="a2" href="FashionBoard.jsp?id=<%out.print(list.get(i+1).getId());%>&table=<%=table%>"><img src="<%out.print(list.get(i+1).getMain_img());%>" id="imgnew"></a>
                    <div id="div1"><a href="FashionBoard.jsp?id=<%out.print(list.get(i+1).getId());%>&table=<%=table%>"><%out.print(list.get(i+1).getName());%></a>
                ...
                <td id="newtd">
                    <a id="a2" href="FashionBoard.jsp?id=<%out.print(list.get(i+2).getId());%>&table=<%=table%>"><img src="<%out.print(list.get(i+2).getMain_img());%>" id="imgnew"></a>
                    <div id="div1"><a href="FashionBoard.jsp?id=<%out.print(list.get(i+2).getId());%>&table=<%=table%>"><%out.print(list.get(i+2).getName());%></a>
               ...
               <td id="newtd">
                    <a id="a2" href="FashionBoard.jsp?id=<%out.print(list.get(i+3).getId());%>&table=<%=table%>"><img src="<%out.print(list.get(i+3).getMain_img());%>" id="imgnew"></a>
                    <div id="div1"><a href="FashionBoard.jsp?id=<%out.print(list.get(i+3).getId());%>&table=<%=table%>"><%out.print(list.get(i+3).getName());%></a>
            ...
            %>
                <td id="newtd">
                    <a id="a2" href="FashionBoard.jsp?id=<%out.print(list.get(j).getId());%>&table=<%=table%>"><img src="<%out.print(list.get(j).getMain_img());%>" id="imgnew"></a>
                    <div id="div1"><a href="FashionBoard.jsp?id=<%out.print(list.get(j).getId());%>&table=<%=table%>"><%out.print(list.get(j).getName());%></a>
