...
<body style="margin: 0;">
	...
	<hgroup style="margin-top: 300px;">
		...
		<h3 style="font-size: 16px; color: #4a89dc">가입하신 방법에 따라 아이디와 비밀번호
			찾기가 가능합니다.</h3>
	</hgroup>
	<form style="margin-bottom: 120px;" name=login method=post
		action=findMemberDatabase.jsp>
		<div class="group">
			<input type="text" name="member_id"><span class="highlight"></span><span
				class="bar"></span> <label>아이디</label>
		</div>
		<div class="group">
			<input type="text" name="email"><span class="highlight"></span><span
